...
function UserPage() {
  ...
  return (
    <div className='h-screen md:grid md:grid-cols-[20%_auto]'>
      <aside className='relative bg-teal-600 text-center p-2 text-teal-50 h-10 md:h-screen md:text-lg md:shadow-[0_0_30px_-8px_gray] md:border-r-2 md:border-teal-800 md:border-opacity-30 md:flex md:flex-col md:justify-center'>
        ...
        <ul className={`absolute bg-teal-600 w-full left-0 transition-all flex flex-col gap-2 p-1 ${menu ? "opacity-100 z-10" : "opacity-0 -z-10"} md:static md:opacity-100 md:z-10 md:gap-3`}>
          ...
          <li className='flex justify-center'>
            <NavLink to="" className="flex flex-row items-center gap-1 hover:text-teal-200" onClick={() => setMenu(false)}><AiOutlineHome />Home</NavLink>
          </li>
          <li className='flex justify-center'>
            <NavLink to="profile"  className="flex flex-row items-center gap-1 hover:text-teal-200" onClick={() => setMenu(false)}><AiOutlineUser />Perfil</NavLink>
          </li>
          <li className='flex justify-center'>
            <NavLink to="lists"  className="flex flex-row items-center gap-1 hover:text-teal-200" onClick={() => setMenu(false)}><AiOutlineUnorderedList />Listas</NavLink>
          </li>
