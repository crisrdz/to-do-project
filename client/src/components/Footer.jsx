...
function Footer() {
  return (
    <footer
      className="absolute bottom-0 h-28 w-full bg-teal-800 text-teal-50 text-xs flex justify-center items-center text-center border-opacity-40 border-t-teal-900 border-t-4 md:h-32 md:text-sm"
    >
